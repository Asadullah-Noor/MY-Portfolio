  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 w-full bg-gradient-to-t from-black to-gray-500 text-white p-4">
      <div className="mt-10 w-auto mx-4">
        <img src="/src/assets/asad.jpg" className="h-50 rounded-xl w-auto" alt="Portfolio" />
        ...
        <div className="grid grid-cols-2 gap-2 mt-4">
          <Link
            to="/project"
            className="cursor-pointer text-white bg-gray-800 border-t-2
            
            border-white rounded flex items-center justify-center hover:bg-black
             hover:border-black transition-transform hover:scale-105 duration-500 p-2"
          >
        ...
        <div className="grid grid-cols-3 gap-4 mt-4">
          <a href="https://github.com/Asadullah-Noor"><FaGithub className="text-3xl
           hover:text-cyan-700" /><p>GitHub</p></a>
          <a href="https://www.linkedin.com/in/asadullahnoor-tech/"><IoLogoLinkedin 
          className="text-3xl hover:text-cyan-600" /><p>LinkedIn</p></a>
          <a href="https://x.com/Asadullah_Nor"><FaXTwitter className="text-3xl
           hover:text-cyan-600" /><p>Twitter</p></a>
...
<div className=" p-2 text-center">
      ...
      <div className="pt-10 px-4">
        <h1 className="text-4xl font-bold text-cyan-400">Every great code 
          
          begins with an even better story</h1>
        <p className="mt-4">
          My pursuit of a software engineering career began in 10th grade. 
          
          Following high school,
          I gained foundational skills in HTML and CSS through FreeCodeCamp. I then progressed to
          developing self-directed projects, expanding my expertise to include 
        ...
        <h1 className="text-2xl font-bold text-white flex items-center mt-10">
          <img src="/src/assets/customer-service.png" className="h-10 w-auto mr-2" alt="Tools" />Tools
        </h1>

        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-4">
          <div className="bg-gray-800 rounded-2xl text-center p-2
           hover:bg-amber-700 hover:scale-110 transition-transform">
            <span className="text-amber-400">JS</span> <span>Javascript</span>
          </div>
          <div className="bg-gray-800 rounded-2xl text-center p-2
           hover:bg-red-800 hover:scale-110 transition-transform">
            <span className="text-red-400">H5</span> <span>HTML</span>
          </div>
          <div className="bg-gray-800 rounded-2xl text-center p-2
           hover:bg-cyan-500 hover:scale-110 transition-transform">
            <span className="text-cyan-800">C3</span> <span>CSS</span>
          </div>
          <div className="bg-gray-800 rounded-2xl text-center p-2
           hover:bg-emerald-900 hover:scale-110 transition-transform">
